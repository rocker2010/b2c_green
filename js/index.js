if($.trim($('#widgetzone_Footer-Widget').html()) == '') { $(".footer .footer-widgets").css('padding', '0'); } $(".fade .title-blog").animate({ top: 0, opacity: 1, }, 2000);
$(".fade .line-header").animate({ opacity: 1, }, 1000);
...
$(window).scroll(function() { if($(window).scrollTop() > 200) { $(".fixnav .header").addClass("fix-header"); } else { $(".fixnav .header").removeClass("fix-header"); } });
...
$(window).scroll(function() { if($(window).scrollTop() > 200) { $('.scrollup').fadeIn(); } else { $('.scrollup').fadeOut(); } });
...
window.selectnav = function() {
	...
	var n = function(n, t) {
		...
		function h(n) { var t = n.nodeName.toLowerCase(); return t === "ul" || t === "ol" }

		function c(n) { for(var t = 1; document.getElementById("selectnav" + t); t++); return n ? "selectnav" + t : "selectnav" + (t - 1) }
